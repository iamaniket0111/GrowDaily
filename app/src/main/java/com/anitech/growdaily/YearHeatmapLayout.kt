...
class YearHeatmapLayout @JvmOverloads constructor(
    ...
    fun bindHeatmap(
        ...
        val lightTaskColor = lightenColor(activeColor, 0.75f)
        val futureColor = Color.parseColor("#F5F5F5")
        val beforeStartColor = Color.parseColor("#E0E0E0")
        ...
        for (i in cells.indices) {
            ...
            when {
                ...
                completedDates.contains(date) -> {
                    box.setBackgroundColor(activeColor)
                }

                else -> {
                    box.setBackgroundColor(lightTaskColor)
                }
            }
        }
    }
